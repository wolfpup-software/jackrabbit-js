...
const consolidate = (action) => {
    switch (action.action) {
        ...
        case START_TEST_COLLECTION:
            startTestCollection$1(action.params);
            break;
        case START_TEST:
            startTest$1(action.params);
            break;
        case CANCEL_RUN:
        ...
        case END_TEST_COLLECTION:
            endTestCollection$1(action.params);
            break;
        case END_TEST_RUN:
            endTestRun$1(action.params);
            break;
    }
...
const sleep = (time) => __awaiter$1(void 0, void 0, void 0, function* () {
...
const createTestTimeout = (timeoutInterval) => __awaiter$1(void 0, void 0, void 0, function* () {
...
const runTestsAllAtOnce = ({ startTime, collectionID, tests, timeoutInterval, }) => __awaiter$1(void 0, void 0, void 0, function* () {
...
const runTestsInOrder = ({ startTime, collectionID, tests, timeoutInterval, }) => __awaiter$1(void 0, void 0, void 0, function* () {
    let testID = 0;
    for (const testFunc of tests) {
        if (startTime < getStub()) {
            return;
